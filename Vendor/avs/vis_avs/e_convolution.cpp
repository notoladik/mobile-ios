...
class Effect;
class Effect_Info;
Effect_Info* create_Convolution_Info() { return nullptr; }
Effect* create_Convolution(AVS_Instance* avs) { (void)avs; return nullptr; }
void set_Convolution_desc(char* desc) { (void)desc; }
#endif
