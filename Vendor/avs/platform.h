...
#ifdef __APPLE__
#define thread_t avs_thread_t
#define thread_create avs_thread_create
#define thread_current avs_thread_current
#define thread_join avs_thread_join
#define thread_join_all avs_thread_join_all
#define thread_decrease_priority avs_thread_decrease_priority
#define thread_destroy avs_thread_destroy
#endif
