                            ...
                            const std::string& fragmentShaderSource)
{
    ...
    glBindAttribLocation(m_shaderProgram, 0, "pos");
    glBindAttribLocation(m_shaderProgram, 0, "in_pos");
    glBindAttribLocation(m_shaderProgram, 0, "_vPosition");

    glBindAttribLocation(m_shaderProgram, 1, "vertex_color");
    glBindAttribLocation(m_shaderProgram, 1, "color");
    glBindAttribLocation(m_shaderProgram, 1, "vertexColor");
    glBindAttribLocation(m_shaderProgram, 1, "in_color");
    glBindAttribLocation(m_shaderProgram, 1, "_vDiffuse");

    glBindAttribLocation(m_shaderProgram, 2, "vertex_texture");
    glBindAttribLocation(m_shaderProgram, 2, "tex_coord");
    glBindAttribLocation(m_shaderProgram, 2, "vertexUV");
    glBindAttribLocation(m_shaderProgram, 2, "uv");
    glBindAttribLocation(m_shaderProgram, 2, "in_uv");
    glBindAttribLocation(m_shaderProgram, 2, "texcoord");
    glBindAttribLocation(m_shaderProgram, 2, "_uv");

    glBindAttribLocation(m_shaderProgram, 3, "vertex_rad_ang");
    glBindAttribLocation(m_shaderProgram, 3, "rad_ang");
    glBindAttribLocation(m_shaderProgram, 3, "_rad_ang");

    glBindAttribLocation(m_shaderProgram, 4, "transforms");
    glBindAttribLocation(m_shaderProgram, 4, "_zoom_rot_warp");

    glBindAttribLocation(m_shaderProgram, 5, "warp_center");
    glBindAttribLocation(m_shaderProgram, 5, "_center");

    glBindAttribLocation(m_shaderProgram, 6, "warp_distance");
    glBindAttribLocation(m_shaderProgram, 6, "_distance");

    glBindAttribLocation(m_shaderProgram, 7, "stretch");
    glBindAttribLocation(m_shaderProgram, 7, "_stretch");
