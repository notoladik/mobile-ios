...
void Mesh::Draw()
{
    ...
    // Ensure VBOs and attributes are bound directly for OpenGL ES 2.0/3.0
    m_vertices.Bind();
    ...
    if (m_useColorAttributes)
    {
        ...
        VertexBuffer<class Color>::SetEnableAttributeArray(1, true);
    }
    else
    {
        VertexBuffer<class Color>::SetEnableAttributeArray(1, false);
    }
    ...
    if (m_useUVAttributes)
    {
        ...
        VertexBuffer<TextureUV>::SetEnableAttributeArray(2, true);
    }
    else
    {
        VertexBuffer<TextureUV>::SetEnableAttributeArray(2, false);
    }
