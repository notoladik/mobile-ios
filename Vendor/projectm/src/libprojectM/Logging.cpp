...
Logging::UserCallback Logging::m_threadCallback = {};

Logging::LogLevel Logging::m_globalLogLevel = LogLevel::NotSet;
Logging::LogLevel Logging::m_threadLogLevel = LogLevel::NotSet;
...
{
    fprintf(stderr, "[projectM] %s\n", message.c_str());
    syslog(LOG_INFO, "[projectM] %s", message.c_str());
