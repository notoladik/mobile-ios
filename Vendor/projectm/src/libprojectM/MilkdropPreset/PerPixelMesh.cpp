                              ...
                              const PerFrameContext& perFrameContext)
{
    ...
    if (!m_warpShader)
    {
        ...
        perPixelMeshShader->SetUniformInt("sampler_main", 0);
    ...
    Renderer::VertexBuffer<Renderer::Point>::SetEnableAttributeArray(3, false);
    Renderer::VertexBuffer<Renderer::Point>::SetEnableAttributeArray(4, false);
    Renderer::VertexBuffer<Renderer::Point>::SetEnableAttributeArray(5, false);
    Renderer::VertexBuffer<Renderer::Point>::SetEnableAttributeArray(6, false);
    Renderer::VertexBuffer<Renderer::Point>::SetEnableAttributeArray(7, false);
